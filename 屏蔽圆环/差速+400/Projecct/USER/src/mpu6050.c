...
{
  simiic_write_reg(MPU6050_Port,MPU6050_DEV_ADDR, PWR_MGMT_1, 0x00);	   //解除休眠状态
  simiic_write_reg(MPU6050_Port,MPU6050_DEV_ADDR, SMPLRT_DIV, 0x07);      //125HZ采样率
...
void MPU6050_Init(void)
{
  ...
  i2c_write_reg(MPU6050_Port,MPU6050_DEV_ADDR, PWR_MGMT_1, 0x00);	   //解除休眠状态
  i2c_write_reg(MPU6050_Port,MPU6050_DEV_ADDR, SMPLRT_DIV, 0x07);      //125HZ采样率
