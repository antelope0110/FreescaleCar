...
//--------------------------------------------------------------------------------------------------
#define OV7725_PCLK             B9                            	//摄像头像素时钟
#define PCLK_CHANNEL            9                              //OV7725_PCLK对应引脚的引脚号  PTE0  -->   0
        
#define OV7725_VSYNC            B17                          	//摄像头场同步信号
#define VSYNC_CHANNEL           17                              //OV7725_VSYNC对应引脚的引脚号 PTE1  -->   1
        

#define INTERRUPT_NUNBERS       PORTB_IRQn                      //中断编号
#define INTERRUPT_ISFR          PORTB->ISFR                     //中断标志位
#define INTERRUPT_VECTORn       PORTB_VECTORn                   //中断编号
...
#define OV7725_DATAPORT 		B_IN_DATA(0)	                //DMA数据口
